...
안녕하세요. 새로운 기술을 배우고 직접 프로젝트로 만들어보는 것을 좋아하는 학생 개발자입니다.

- 📱 Flutter를 이용한 모바일 앱 개발
- 🌐 React / Next.js를 이용한 웹 개발
- ⚡ Supabase를 활용한 백엔드 및 데이터베이스
...
<img src="https://skillicons.dev/icons?i=flutter,dart,react,nextjs,ts,js,tailwind,html,css&theme=dark" />
